...
const Feautures = () => {
  ...
  return (
    <>
      ...
      >
        <Image src={languages} alt="programming" className='w-7 h-7' />
        <h1 className="nocursor font-semibold text-[#E4E4E7] mb-4">
      ...
      <motion.div
        ...
        className="box hover:scale-[1.1] hover:rgba(83,83,83,0.3) transition-all hover:shadow-[0px_0px_10px_gray] duration-500"
      >
        <h1 className="nocursor font-semibold text-[#E4E4E7] mb-4 text-[15px]">
